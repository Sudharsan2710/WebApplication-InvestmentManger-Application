...
<title>Nippon India Small Cap Fund</title>
...
<body>
            ...
            <section class="main-content">
                ...
                <div class="form-container">
                    <h1 class="mutual-fund-title">
                     <img src="./img/nippon.png" alt="Company Logo" /> 
                    ...
                    <form class="mutual-fund-form" id="investment-form">
                        ...
                        <input type="number" name="rateOfReturn" id="rateOfReturn" value="15.00" step="0.01" readonly>
    ...
    <script>
        ...
        function calculateInvestment() {
            ...
            drawChart(data);
            document.getElementById('invest-now-button').style.display = 'block';
        }
