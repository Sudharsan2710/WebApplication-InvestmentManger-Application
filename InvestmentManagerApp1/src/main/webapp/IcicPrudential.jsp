...
<title>ICIC Prudential Value Discovery Fund</title>
        ...
        <div class="mutual-fund-wrapper">
            ...
            <section>
                <div class="mutual-fund-container">
                    <h1 class="mutual-fund-title">ICIC Prudential Value Discovery Fund</h1>
                    <form class="mutual-fund-form" action="calculate" method="post">
                        ...
                        <input type="number" name="rateOfReturn" value="24.05" step="0.01" readonly><br>
